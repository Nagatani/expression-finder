...
export class Expression {
    ...
    get prog() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_expression_prog(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get tex() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_expression_tex(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set tex(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_expression_tex(this.__wbg_ptr, ptr0, len0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_expression_new = function(arg0) {
        const ret = Expression.__wrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('expression_finder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
